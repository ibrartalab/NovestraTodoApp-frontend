...
import type { MarkTodoInput, Todo, UpdateTodoInput } from "../features/todos/types";
...
export const updateTodo = (id:number, data:UpdateTodoInput | MarkTodoInput) => axiosPrivate.put(`/Todo/${id}`, data);
