...
const TodosProvider = ({children}:TodosProviderType) => {
    ...
    return(
        <TodoContext.Provider value={{todos,currentState,totalTodos,totalTodosCompleted,totalTodosPending,setCurrentState,setTodos,fetchTodos,setTotalTodos,setTotalTodosCompleted,setTotalTodosPending}}>
            {children}
